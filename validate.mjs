...
if (inlineScripts.length !== 6 || !editorScript || !loaderScript || !inlineScripts.at(-1).includes('DKLoader.finish') || !html.includes('id="weapon-editor-screen"') || !html.includes('data-editor-tab="bulletAdvanced"') || !html.includes('data:font/ttf;base64,')) throw new Error('Offline loading or Weapon/Bullet Maker bundle is incomplete.');
